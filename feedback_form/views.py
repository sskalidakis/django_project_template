    ...
    #     username = request.user.username
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                email_text = 'User: "' + str(username) + '" submitted his/her feedback on the Platform, regarding: "' + str(
                ...
                if result['success']:
                    ...
                    try:
                        send_mail(str(username) + "'s Feedback on the Platform", email_text, 'noreply@epu.ntua.gr',
                                  ['myemail@hotmail.com'],
                                  fail_silently=False)
                    except:
                        messages.error(request, 'The evaluation was stored but email to the project could not be sent! SMTP server credentials may be wrong!')
                        print('The evaluation was stored but email to the project could not be sent! SMTP server credentials may be wrong!')
